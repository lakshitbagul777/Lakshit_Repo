...
class PASS1 
{
	public static void main(String args[]) throws NullPointerException, FileNotFoundException
	{
	 ...
	 String line; 
	 try{
		 BufferedReader br=new BufferedReader(new FileReader("C:/Users/adity/OneDrive/Desktop/SPOSLab/Assembler/Sample.txt"));
		 BufferedWriter bw=new BufferedWriter(new FileWriter("C:/Users/adity/OneDrive/Desktop/SPOSLab/Assembler/Output.txt"));
