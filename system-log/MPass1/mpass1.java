...
public class mpass1 {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br1=new BufferedReader(new FileReader("C:\\Users\\adity\\OneDrive\\Desktop\\SPOSLab\\MPass1\\sample.txt"));
        String line;
        mdt[] MDT=new mdt[20];
        mnt[] MNT=new mnt[4];
        ...
        BufferedWriter bw1=new BufferedWriter(new FileWriter("C:\\Users\\adity\\OneDrive\\Desktop\\SPOSLab\\MPass1\\MNT.txt"));
        System.out.println("\n\t********MACRO NAME TABLE**********");
        System.out.println("\n\tINDEX\tNAME\tADDRESS");
        ...
        bw1.close();
        bw1=new BufferedWriter(new FileWriter("C:\\Users\\adity\\OneDrive\\Desktop\\SPOSLab\\MPass1\\ARGLIST.txt"));
        System.out.println("\n\n\t********ARGUMENT LIST**********");
        System.out.println("\n\tINDEX\tNAME\tADDRESS");
        ...
        bw1=new BufferedWriter(new FileWriter("C:\\Users\\adity\\OneDrive\\Desktop\\SPOSLab\\MPass1\\MDT.txt"));
